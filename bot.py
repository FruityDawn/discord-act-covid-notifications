...
def parse_url(url):
	...
	df_cases = pd.read_csv(latest_cases[1:-1], names = ['Event ID', 'Status', 'Exposure Site', 'Street', 'Suburb', 'State', 'Date', 'Arrival Time', 'Departure Time', 'Contact', 'Extra']).drop(['Event ID', 'Status', 'State', 'Extra'], axis = 1) # Remove quote marks from url
